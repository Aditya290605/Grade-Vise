      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final hasAssignments =
              [1, 2, 4].contains(index)
                  ? index + 1
                  : 0; // Mock data for assignments
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'Would you like to join the Google Meet session for ${course.name} with ${course.teacherName}?',
          ),
          actions: [
            TextButton(
              onPressed: () {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text(
              'Could not launch Google Meet. Please check your connection.',
            ),
            actions: [
              TextButton(
                onPressed: () {
